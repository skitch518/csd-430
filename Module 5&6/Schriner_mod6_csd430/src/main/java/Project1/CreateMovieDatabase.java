...
public class CreateMovieDatabase {
    ...
    public static void main(String[] args) {
        ...
        String createTableSQL = "CREATE TABLE IF NOT EXISTS movies (" +
                "id INT PRIMARY KEY, " +  // make sure this matches the insert statement
        ...
        String insertDataSQL = "INSERT INTO movies (id, title, director, genre, rating, length) VALUES " +
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password)) {
            ...
            try (Statement stmt = connection.createStatement()) {
                ...
                System.out.println("Table 'movies' dropped (if it existed).");
            }
